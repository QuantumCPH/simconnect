...
<tr bgcolor="#CCCCCC" class="receipt_header">
  ...
  <tr>
    ...
    <td align="right" style="padding-right:28px;"><?php echo sfConfig::get('app_currency_code');?><?php echo number_format($subtotal = $agent_order->getAmount(),2) //($order->getProduct()->getPrice() - $order->getProduct()->getPrice()*.2) * $order->getQuantity()) ?></td>
  </tr>
  <tr>
  ...
  <tr class="footer">
    ...
    <td>&nbsp;</td>
    <td align="right" style="padding-right:28px;"><?php echo sfConfig::get('app_currency_code');?><?php echo number_format($subtotal,2) ?></td>
  </tr>
  <tr class="footer">
    <td>&nbsp;</td>
    <td><?php echo __('VAT') ?></td>
    <td>&nbsp;</td>
    <td align="right" style="padding-right:28px;"><?php echo sfConfig::get('app_currency_code');?><?php echo number_format(0,2) ?></td>
  </tr>
  <tr class="footer">
    <td>&nbsp;</td>
    <td><?php echo __('Total') ?></td>
    <td>&nbsp;</td>
    <td align="right" style="padding-right:28px;"><?php echo sfConfig::get('app_currency_code');?><?php echo number_format($agent_order->getAmount(),2) ?></td>
  </tr>
</table>
<?php if($wrap_content): ?>
<br />
