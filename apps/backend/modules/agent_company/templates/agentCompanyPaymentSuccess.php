...
<div class="borderDiv">     
    ...
    <table cellspacing="0" width="75%" class="tblAlign">
        ...
        <tr class="headings">
            ...
            <th align="right" style="text-align: right;padding-right: 15px;"><?php echo __('Amount') ?></th>
        ...
        <tr <?php echo 'class="'.($i%2 == 0?'odd':'even').'"' ?>>
            ...
            <td align="right" style="padding-right: 15px;"><?php echo sfConfig::get('app_currency_code');?><?php  echo number_format($agent->getAmount(),2);?></td>
