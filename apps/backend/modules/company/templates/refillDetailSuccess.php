...
<form id="sf_admin_form" name="sf_admin_edit_form" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="company_id" value="<?php echo $company->getId()?>" />
            ...
            <tr>
                ...
                <td style="padding: 5px;">
                    <b><?php echo sfConfig::get('app_currency_code');?></b>
                    <input type="hidden" name="refillAmt" value="<?php echo $refillAmt?>" />                    
                    <?php echo number_format($refillAmt, 2);?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 5px;">
                    <b><?php echo sfConfig::get('app_currency_code');?></b>
                    <input type="hidden" name="totalPayment" value="<?php echo $refillAmt+$vat?>" />                    
                    <?php echo number_format($refillAmt+$vat,2);?>
                </td>
            </tr>
