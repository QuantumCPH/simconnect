...
<tr bgcolor="#CCCCCC" class="receipt_header">
  ...
  <tr>
    ...
    <td align="right" style="padding-right: 65px;"><?php   format_number($subtotal = $agent_order->getAmount()); echo sfConfig::get('app_currency_code');echo number_format($subtotal,2);   //($order->getProduct()->getPrice() - $order->getProduct()->getPrice()*.2) * $order->getQuantity())    ?></td>
  </tr>
  <tr>
  ...
  <tr class="footer">
    ...
    <td>&nbsp;</td>
    <td align="right" style="padding-right: 65px;"><?php echo sfConfig::get('app_currency_code');?><?php echo format_number(0.00) ?></td>
  </tr>
  <tr class="footer">
    <td>&nbsp;</td>
