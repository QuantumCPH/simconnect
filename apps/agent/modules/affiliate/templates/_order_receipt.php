...
<table class="receipt" cellspacing="0" width="600px">
 ...
 <?php } ?> 
  ...
  <tr class="footer">
    ...
    <td>&nbsp;</td>
    <td align="right" style="padding-right: 65px;"><?php echo sfConfig::get('app_currency_code')?><?php  $subTotal = $order->getProduct()->getPrice()+$order->getProduct()->getRegistrationFee();  echo number_format($subTotal,2) ?></td>
  </tr>
  <tr class="footer">
    <td>&nbsp;</td>
