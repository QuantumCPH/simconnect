...
<tr bgcolor="#CCCCCC" class="receipt_header"> 
  ...
  <tr> 
    ...
    <td align="right" style="padding-right: 65px;"><?php echo format_number($subtotal = $transaction->getAmount()-$vat) //($order->getProduct()->getPrice() - $order->getProduct()->getPrice()*.2) * $order->getQuantity()) ?></td>
  </tr>
  <tr>
  ...
  <tr class="footer"> 
    ...
    <td>&nbsp;</td>
    <td align="right" style="padding-right: 65px;"><?php echo format_number($subtotal) ?></td>
  </tr>
  <tr class="footer"> 
    <td>&nbsp;</td>
    <td><?php echo __('VAT') ?><!-- (<?php //echo $vat==0?'0%':sfConfig::get('app_vat') ?>)--></td>
    <td>&nbsp;</td>
    <td align="right" style="padding-right: 65px;"><?php echo sfConfig::get('app_currency_code')?><?php echo format_number($vat) ?></td>
  </tr>
  <tr class="footer">
    <td>&nbsp;</td>
