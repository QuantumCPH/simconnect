...
<table class="receipt" cellspacing="0" width="600px">
 ...
 <td align="right" style="padding-right: 65px;"><?php echo __('Amount') ?> <!--   (<?php //echo sfConfig::get('app_currency_code');?>)--> </td>
  ...
  <tr>
    ...
    <td align="right" style="padding-right: 65px;"><?php echo sfConfig::get('app_currency_code');?><?php  $subTotal = $transaction->getAmount()-$vat;  echo number_format($subTotal,2);      ?></td>
  </tr>
  <tr>
