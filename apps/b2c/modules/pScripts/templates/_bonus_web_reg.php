...
<?php if($wrap_content): ?>
	...
	<p>
	<?php echo __('%1% has added  %2%10.00 of airtime to your account balance for inviting a friend to register as a %1% customer. Thank you.',array('%1%'=>sfConfig::get('app_site_title'), '%2%'=>sfConfig::get('app_currency_code'))); ?>
	</p>
        <p>
...
<table width="600px">
	<tr style="border:0px solid #fff">
		<td colspan="4" align="right" style="text-align:right; border:0px solid #fff"><?php echo image_tag(sfConfig::get('app_site_url').'images/logo.png');?></td>
	</tr>
</table>
